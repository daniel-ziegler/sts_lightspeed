...
class EventOption:
    ...
    def __repr__(self):
        return f"EventOption(text={self.text}, label={self.label}, disabled={self.disabled}, choice_index={self.choice_index})"
...
class EventScreen(Screen):
    ...
    def __repr__(self):
        return f"EventScreen(name={self.event_name}, event_id={self.event_id}, body_text={self.body_text}, options={self.options})"

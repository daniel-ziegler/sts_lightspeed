...
class Action:
    ...
    def __repr__(self):
        return f"{self.__class__.__name__}({self.command!r})"
...
class PlayCardAction(Action):
    ...
    def __repr__(self):
        return f"PlayCardAction(card={self.card.name if self.card else None}, card_index={self.card_index}, target_monster={self.target_monster.name if self.target_monster else None}, target_index={self.target_index})"
...
class ChooseAction(Action):
    ...
    def __repr__(self):
        return f"ChooseAction(choice_index={self.choice_index}, name={self.name})"

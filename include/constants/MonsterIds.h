...
namespace sts {
    ...
    static constexpr const char* const monsterEnumNames[] = {
            "INVALID = 0",
            "ACID_SLIME_L",
            "ACID_SLIME_M",
            "ACID_SLIME_S",
    ...
    static constexpr const char* const monsterNameStrings[] = {
            "Invalid",
            "Acid Slime (L)",
            "Acid Slime (M)",
            "Acid Slime (S)",
    ...
    static const char* getMonsterEnumName(MonsterId id) {
        return monsterEnumNames[static_cast<int>(id)];
    }

    static const char* getMonsterIdString(MonsterId id) {
        return monsterIdStrings[static_cast<int>(id)];
    }

    static const char* getMonsterName(MonsterId id) {
        return monsterNameStrings[static_cast<int>(id)];
    }

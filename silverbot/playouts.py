...
from silverbot.network import NN, ActionType, FixedAction, EventFixedInfo, ModelHP, collate_fn, process_batch, output_to_cpu, choice_space, move_to_device, load_network_backward_compatible
from silverbot.inputs import Path
...
def choose_overworld_action(service, choice: Choice, gc: sts.GameContext, rng,
    ...
    from silverbot.network import CHOICE_PATHS_OFFSET
